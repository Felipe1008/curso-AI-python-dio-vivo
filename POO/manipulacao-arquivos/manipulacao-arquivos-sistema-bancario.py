...
# Devido a quantidade crescente de atividades, torna-se difícil acompanhar todas as operações em tempo real.
# Dessa forma, decidimos que é vital registrar essas informações em um arquivo para análise posterior.
# Requisitos
...
def log_transacao(func):
    def envelope(*args, **kwargs):
        ...
        # Armazenando data e hora
        data_hora = datetime.now(timezone.utc).strftime("%Y-%m-%d %H:%M:%S")
        # Criando o arquivo com o modo 'a', para se o arquivo existir, ele adicionará as novas linhas ao final do arquivo
        with open('log.txt', 'a') as arquivo:
            arquivo.write(
                # Atendendo aos requisitos: data e hora, nome, argumentos e resultado da função
